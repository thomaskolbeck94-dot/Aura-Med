...
Ein kritisches Problem bei GS1-Codes auf Medikamenten is das Fehlen eines exakten Tages auf der Klarschriftverpackung (z. B. "EXP: 05/2028"). Im DataMatrix-Code wird dies über den Tag 00 kodiert (z. B. 280500). Der Parser muss diesen Zustand mathematisch abfangen:
